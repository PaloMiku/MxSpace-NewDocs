...
import { UimDocker } from 'app/components/Icons/Docker';
import { UimStar } from 'app/components/Icons/Star';
import { FluentPeopleCommunity } from 'app/components/Icons/PeopleCommunity';
import { UilExternalLinkAlt } from 'app/components/Icons/ExternalLinkAlt';
import { UilPaintTool } from 'app/components/Icons/PaintTool';

<Cards>
  <Card title="Docker 部署" href="/docs/core/docker" icon={<UimDocker />} />
  <Card title="进阶部署" href="/docs/core/advanced" icon={<UimStar />} />
  <Card title="社区部署教程" href="/docs/core/community" icon={<FluentPeopleCommunity />} />
  <Card title="相关内容" href="/docs/core/extra" icon={<UilExternalLinkAlt />} />
</Cards>
...
<Cards>
  <Card title="浏览前端主题" href="/themes" icon={<UilPaintTool />} />
</Cards>
