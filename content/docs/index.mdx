...
<Cards>
  <Card title="Docker 部署" href="/docs/docker" icon={<UimDocker />} />
  <Card title="进阶部署" href="/docs/advanced" icon={<UimStar />} />
  <Card title="社区部署教程" href="/docs/community" icon={<FluentPeopleCommunity />} />
  <Card title="相关内容" href="/docs/extra" icon={<UilExternalLinkAlt />} />
</Cards>
